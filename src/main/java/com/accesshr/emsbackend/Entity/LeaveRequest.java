...
public class LeaveRequest {
    ...
    public LeaveRequest(Long id, String employeeId, String firstName, String lastName,
                        String email, String managerId, String managerName,
                        String managerEmail, LocalDate leaveStartDate,
                        LocalDate leaveEndDate, String leaveReason,
                        LeaveType leaveType, boolean LOP,
                        Double duration, String durationType,
                        String comments, String medicalDocument,
