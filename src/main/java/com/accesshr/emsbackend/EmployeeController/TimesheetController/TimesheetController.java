...
public class TimesheetController {
    ...
    @GetMapping(value = "/list/{employeeId}", produces = "application/json")
    ...
    @GetMapping(value = "/list/manager/{managerId}", produces = "application/json")
    ...
    @PutMapping(value = "/reject/{id}/status/{status}/comments/{comments}", produces = "application/json")
